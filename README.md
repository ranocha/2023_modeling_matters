...
is suited for numerical simulations. The intention of our story is 
to motivate combining analytical and numerical know\-ledge, even in 
cases where the world looks fine on first sight. We have set up an
